...
/**
 * 继承 security 的 User 好像反序列化得不到子类，直接从写好点
 */
@JsonSerialize
...
//    }
    ...
    public boolean equals(Object rhs) {
        if (rhs instanceof CustomUserDetails){
            return this.getUsername().equals(((CustomUserDetails) rhs).getUsername()) && this.getUserId().equals(((CustomUserDetails) rhs).getUserId());
        }
        return false;
    }
    ...
    @Override
    public int hashCode() {
        return this.getUsername().hashCode() + this.getUserId().hashCode();
    }
